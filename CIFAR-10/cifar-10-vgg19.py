...
x = Conv_BN_Relu(64, (3, 3), 1, input_layer)
...
x = Conv_BN_Relu(256, (3, 3), 1, x)
x = Conv_BN_Relu(256, (3, 3), 1, x)
x = Conv_BN_Relu(256, (3, 3), 1, x)
x = Conv_BN_Relu(256, (3, 3), 1, x)
x = MaxPooling2D((2,2),strides=1,padding='same')(x)

x = Conv_BN_Relu(512, (3, 3), 1, x)
x = Conv_BN_Relu(512, (3, 3), 1, x)
x = Conv_BN_Relu(512, (3, 3), 1, x)
x = Conv_BN_Relu(512, (3, 3), 1, x)
x = MaxPooling2D((2,2),strides=1,padding='same')(x)
...
plt.title('CIFAR-10: VGG19 without data augmentation')
plt.xlabel('epochs')
plt.ylabel('Traing Accuracy / Loss')
plt.plot(epochs, acc, 'red', label='Training Accuracy')
plt.plot(epochs, loss, 'blue', label='Traing Loss')
plt.legend()
plt.savefig('E:\Results\VGG19-1.png')
plt.show()